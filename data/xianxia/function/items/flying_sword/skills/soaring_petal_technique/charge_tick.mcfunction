...
execute if score @s fs_use_held matches 1.. if predicate xianxia:input/sneak if items entity @s weapon.mainhand minecraft:diamond_sword[custom_data~{flying_sword:1b}] if items entity @s weapon.offhand minecraft:book[custom_data~{skill:"soaring_petal_technique"}] run scoreboard players add @s fs_spt_charge 1
...
execute if score @s fs_spt_charge matches 1.. unless items entity @s weapon.offhand minecraft:book[custom_data~{skill:"soaring_petal_technique"}] run function xianxia:items/flying_sword/skills/soaring_petal_technique/charge_cancel
