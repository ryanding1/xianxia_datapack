...
execute if items entity @s container.* minecraft:stick[custom_data~{flying_sword_controller:1b,flying_sword_controller_skill:"soaring_petal_technique"}] run function xianxia:items/flying_sword/inventory/to_sword
