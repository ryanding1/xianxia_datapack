...
execute if score @s fs_spt_next matches ..0 run scoreboard players set @s fs_spt_next 0
...
function xianxia:items/flying_sword/skills/soaring_petal_technique/move_recall_macro with storage xianxia:items/flying_sword/skills/soaring_petal_technique/config
