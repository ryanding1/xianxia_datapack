# Put the target marker on the player's cursor line at shrinking distance.
...
# Move actual sword toward that target marker.
...
# Update stored distance only if target was valid.
