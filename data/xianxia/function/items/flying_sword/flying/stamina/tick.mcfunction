...
function xianxia:items/flying_sword/flying/stamina/check_refill
function xianxia:items/flying_sword/flying/stamina/check_drain

# Refill first. This means landing instantly restores stamina.
execute if entity @s[tag=flying_sword_can_refill] run function xianxia:items/flying_sword/flying/stamina/refill

# Drain only when the drain condition is true and the refill condition is false.
execute unless entity @s[tag=flying_sword_can_refill] if entity @s[tag=flying_sword_can_drain] if score @s fc_stamina matches 1.. run function xianxia:items/flying_sword/flying/stamina/drain
