...
execute unless entity @s[tag=xianxia_posture_broken] if items entity @s weapon.mainhand #xianxia:parry_weapons[custom_data~{xianxia_parry_weapon:1b}] run function xianxia:parry/guard_protect
execute unless entity @s[tag=xianxia_posture_broken] unless items entity @s weapon.mainhand #xianxia:parry_weapons[custom_data~{xianxia_parry_weapon:1b}] if items entity @s weapon.mainhand minecraft:diamond_sword[custom_data~{flying_sword:1b}] run function xianxia:parry/guard_protect
